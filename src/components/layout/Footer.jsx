...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-white text-gray-800 pt-20 pb-10 px-4 overflow-hidden border-t border-gray-100">
      {/* Luxury Top Border */}
        ...
        <div className="pt-8 border-t border-amber-100">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              className="cursor-pointer relative w-12 h-12 rounded-xl border border-amber-200 bg-gradient-to-br from-white to-amber-50 flex items-center justify-center text-amber-600 hover:text-amber-700 transition-all duration-300"
              aria-label="Back to top"
            >
              <FaChevronUp />
              {/* Golden Glow */}
              <div className="absolute -inset-1 rounded-xl bg-gradient-to-r from-amber-300/20 to-yellow-300/20 blur-sm opacity-0 hover:opacity-100 transition-opacity duration-300" />
            </motion.button>
          </div>
