...
//   const sentences = (director.description || "").split(/(?<=\.)\s+/);
//   const introLine = sentences[0] || "";
...
//             <h2 className="text-3xl font-bold text-amber-900 text-center tracking-tight">
//               {director.name}
//             </h2>
...
//               <p className="text-xl font-semibold text-amber-700 tracking-tight">
//                 {director.title}
//               </p>
//             </div>
...
//                   className="p-3 bg-amber-100 text-amber-700 rounded-full hover:bg-amber-200 hover:text-amber-800 transition-all hover:scale-110"
//                   aria-label="Facebook"
//                 >
//                   <FaFacebookF size={20} />
//                 </a>
...
//             {hasPortfolio && (
//               <a
//                 href={director.portfolio.trim()}
//                 target="_blank"
//                 rel="noopener noreferrer"
//                 className="mt-8 px-6 py-3 bg-gradient-to-r from-amber-600 to-orange-500 text-white rounded-lg hover:from-amber-700 hover:to-orange-600 transition-all font-semibold flex items-center space-x-2 shadow-md"
//               >
//                 <FaBriefcase />
...
//               {/* Intro Quote */}
//               {/* {introLine && (
//                 <blockquote className="text-amber-800 italic text-lg leading-relaxed pl-4 border-l-4 border-amber-400">
//                   “{introLine}.
//                 </blockquote>
//               )} */}
...
//               <div className="pt-6 border-t border-amber-200 flex justify-center">
//                 {/* <button
//                   onClick={onClose}
//                   className="px-8 py-3 border-2 border-amber-600 text-amber-600 rounded-lg hover:bg-amber-50 font-semibold transition-colors"
//                 >
//                   Close Profile
//                 </button> */}
//               </div>
