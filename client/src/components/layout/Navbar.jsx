  ...
  return (
    <>
      ...
      <div className={`fixed top-0 left-0 w-full z-50 shadow-sm `}>
        ...
        <nav
          className={`bg-white/90 backdrop-blur-xl border-b border-gray-300 transition-all ${
            isScrolled ? "shadow-md shadow-gray-400/20" : ""
          }`}
        >
          <div className="max-w-7xl mx-auto px-4">
            <div className="flex h-16 items-center justify-between">
              ...
              <Link className="flex items-center gap-3" to="/">
                ...
                <div className="hidden sm:block">
                  ...
                  <p className="text-xs text-gray-600">Invest for Growth</p>
                </div>
              </Link>
              ...
              <div className="flex items-center gap-4">
                ...
                <motion.button
                  onClick={toggleMenu}
                  className="cursor-pointer relative p-2.5 rounded-xl bg-white border border-gray-300 group"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  <div className="absolute -inset-1 bg-white/30 blur opacity-0 group-hover:opacity-40 rounded-xl" />
                  <div className="relative">
                    {isMenuOpen ? (
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <>
            ...
            <motion.div
              ref={menuRef}
              className="z-[9999] fixed top-0 left-0 h-screen w-[320px] bg-white/95 backdrop-blur-xl shadow-lg border-r border-gray-200 flex flex-col"
              variants={drawerVariants}
              initial="closed"
              animate="open"
              exit="closed"
            >
              ...
              <div className="flex justify-end p-4">
                <button
                  onClick={closeMenu}
                  className="cursor-pointer p-2 rounded-lg text-gray-800 hover:bg-gray-200/20"
                >
                  <HiX size={24} />
                </button>
              </div>
