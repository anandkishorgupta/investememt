...
const OurServices = () => {
  ...
  const cardVariants = {
    ...
    hover: {
      scale: 1.05,
      y: -5,
      boxShadow: "0px 15px 25px rgba(217, 119, 6, 0.35)", // gold glow
      transition: { type: "spring", stiffness: 300, damping: 20 },
    },
  };
  ...
  return (
    <section className="flex items-center justify-center min-h-screen relative py-20 px-4 md:px-8 lg:px-16  overflow-hidden">
      {/* Soft gold glows */}
      <div className="absolute -top-32 -left-32 w-96 h-96 rounded-full bg-amber-200/20 blur-3xl pointer-events-none" />
      <div className="absolute -bottom-32 -right-32 w-96 h-96 rounded-full bg-amber-100/20 blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="mb-12">
          <motion.div
            ...
            className="flex items-center mb-4"
          >
            <div className="w-8 h-0.5 bg-gradient-to-r from-amber-500 to-amber-300 mr-3" />
          ...
          {services.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true, amount: 0.3 }}
                variants={cardVariants}
                className="bg-white border border-amber-200 rounded-3xl p-6 shadow-md flex flex-col items-center text-center group cursor-pointer relative overflow-hidden"
              >
                {/* Icon */}
                <motion.div
                  className="mb-4 w-16 h-16 rounded-2xl bg-gradient-to-br from-amber-500 to-amber-700 flex items-center justify-center shadow-md"
                  variants={iconHoverVariants}
                >
