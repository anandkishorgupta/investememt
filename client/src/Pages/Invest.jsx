    ...
    useEffect(() => {
        const fetchHeroData = async () => {
            try {
                ...
                // Filter only invest=true items
                const investData = res?.portfolio?.filter(item => item.invest === false) || [];
                setData(investData);
            } catch (err) {
                setError(err);
        ...
        <LazyMotion features={domAnimation}>
            <div className="min-h-screen  text-amber-900 relative overflow-hidden">
                ...
                <section className="relative overflow-hidden">
                    <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(212,175,55,0.08),transparent_65%)] -z-10" />
                    <div className="relative max-w-7xl mx-auto px-6 py-20 text-center">
                        ...
                        <motion.p
                            ...
                            className="mt-4 max-w-2xl mx-auto text-amber-800"
                        >
                    ...
                    >
                        ...
                        {data?.map((item) => (
                            <motion.article
                                ...
                                className="group relative rounded-2xl bg-amber-50 border border-amber-200 overflow-hidden shadow-lg hover:shadow-2xl flex flex-col"
                            >
                                {/* Gold hover overlay */}
