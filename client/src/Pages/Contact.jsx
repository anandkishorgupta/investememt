...
//             className="text-amber-800 max-w-2xl mx-auto text-lg"
//           >
//             {subheading}
//           </motion.p>
//         </motion.div>
...
//               whileHover={{ y: -8 }}
//               className="group relative bg-white rounded-2xl p-6 shadow-md hover:shadow-lg border border-[#D4AF37]/40 transition-all"
//             >
...
//             viewport={{ once: true }}
//             transition={{ duration: 0.7 }}
//             className="bg-white rounded-2xl p-6 md:p-8 shadow-md border border-[#D4AF37]/30"
//           >
//             <div className="mb-8">
...
//                     required
//                     className="w-full px-4 py-3 bg-gray-100 border border-[#D4AF37]/40 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#FFD700]/50 focus:border-transparent transition"
//                   />
//                 </div>
//                 <div>
//                   <label className="block text-sm font-medium text-gray-700 mb-2">
...
//                   required
//                   className="w-full px-4 py-3 bg-gray-100 border border-[#D4AF37]/40 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#FFD700]/50 focus:border-transparent transition resize-none"
//                 />
//               </div>
      ...
      <div className="relative py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto z-10">
        ...
        <div className="max-w-3xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.7 }}
            className="bg-amber-50 rounded-2xl p-6 md:p-8 shadow-md border border-[#D4AF37]/30"
          >
            <div className="mb-8">
              <h2 className="text-2xl md:text-3xl font-light text-amber-900">
                {formTitle}
              </h2>
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.99 }}
                className="w-full py-3.5 px-6 rounded-xl font-medium relative overflow-hidden text-amber-900"
                style={{ background: goldGradient }}
              >
                {status === "submitting" ? (
                  <span className="flex items-center justify-center">
        ...
        <motion.div
          ...
          className="mt-20"
        >
          <h2 className="text-2xl font-light text-center text-amber-900 mb-6">
            {mapTitle}
          </h2>
          <div className="rounded-2xl overflow-hidden shadow-lg border border-[#D4AF37]/30 max-w-4xl mx-auto">
            <iframe
